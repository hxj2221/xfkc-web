  ...
  <div class="message">
    ...
    <div>
      <el-table :data="messageList" stripe style="width: 100%">
        ...
        <!-- <el-table-column prop="createBy" label="消息内容" /> -->
        <el-table-column prop="updateTime" label="时间" />
        <el-table-column label="操作">
          <template slot-scope="scope">
            <!-- <el-button size="mini" @click="handleEdit(scope.$index, scope.row)"><img class="see" src="../../assets/message/see.png" alt=""><span>查看</span></el-button> -->
            <el-button size="mini" type="danger" @click="handleDelete(scope.$index, messageList)">
              <img class="see" src="../../assets/message/grdel.png" alt>
              <span>删除</span>
            </el-button>
          </template>
        </el-table-column>
