    ...
    <div class="top">
      <div class="one">
        ...
        <div class="shar" @click="copyUrl">
          <el-image class="sharicon" :src="require('../../assets/school/fenxiang.png')" alt />
    ...
    <div class="new_bg">
      <div class="bigimg">
        <div class="smalltitle" style="margin-bottom: 17px">
          <el-image class="schooltxt" :src="require('../../assets/school/detile.png')" alt />
          <div class="txt_1">学校简介</div>
        </div>
        <div class="txt">{{ school.schoolProfile }}</div>
        <div class="smalltitle" style="margin-top: 112px">
          <el-image :src="require('../../assets/school/teacher.png')" alt />
        ...
        <el-row :gutter="54">
          <!-- <el-col v-for="(item, index) in teacher" :key="index" :span="3">
            <div class="teacherdetil">
              <el-image
                class="teacherimg"
                :src="$commactive.url(item.avatarName)"
                alt
              />
...
.top {
  ...
  width: 1366px;
  height: 126px;
  background-image: url("../../assets/school/bgimg.png");
  padding: 15px 33px;
}
.one {
  display: flex;
...
.new_bg {
  background: linear-gradient(rgba(199, 225, 251, 1), rgba(243, 249, 255, 1));
