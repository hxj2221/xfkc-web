<template>
  <div class="DataUpload">
    ...
    <div class="box_1">
        ...
        <div>
          <div class="shar">
            ...
            <div class="sharbox" @click="share">
              <el-image class="sharicon" :src="require('../../assets/challenge/grshar.png')" alt />
      ...
      <div class="photobox">
        ...
        <div class="right">
          ...
          <div class="right-tab">
            <div class="plist">
              <el-image :src="require('../../assets/challenge/grrenwulist.png')" style="margin-left: 2px" alt />
    ...
    <div class="bottombtn">
      <div class="upbtn">
        <div class="dis2">
          <el-image :src="require('../../assets/challenge/grshangchuan2.png')" alt />
    ...
    <div class="bottombox">
      <div class="disp3">
        <img style="width: 24px; height: 24px;" src="../../assets/challenge/grwenzimiaoshu.png" alt>
      ...
      <div class="disp3">
        <img style="width: 24px; height: 24px;" src="../../assets/challenge/grtupiantubiao.png" alt>
...
import { getChallengeDetail, getPass, getReject } from '@/api/challenge/challengeDetail'
export default {
  name: 'School',
  components: {
    grcrumbs
