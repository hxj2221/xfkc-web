  ...
  <div class="app-container">
    ...
    >
      <div style="text-align: center;margin-top:12px;">
        <el-image style="height:158px;width:158px;" :src="require('../../../assets/challenge/success.png')" alt />
      </div>
      <div style="text-align: center;margin-top:12px;">绑定成功！</div>
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" @click="dialogVisible2 = false">好 的</el-button>
      </span>
    </el-dialog>
    <el-row :gutter="20">
          ...
          <div>
            <div style="text-align: center">
              <div class="el-upload">
                <!-- @click="toggleShow" -->
                <div>
                  <el-image :src="user.avatarName ? $commactive.url(user.avatarName) : Avatar" title="点击上传头像" class="avatar" />
                </div>
                <myUpload
                  v-model="show"
                  :headers="headers"
          ...
          <el-tabs v-model="activeName" @tab-click="handleClick">
            <el-tab-pane label="用户资料" name="first">
              <el-form ref="form" :model="form" :rules="rules" style="margin-top: 10px;" size="small" label-width="65px">
                ...
                <el-form-item label="">
                  <el-button size="mini" type="primary" @click="bindingParent">绑定家长</el-button>
