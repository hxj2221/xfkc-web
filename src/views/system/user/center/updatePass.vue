    ...
    <el-dialog :visible.sync="dialog" :close-on-click-modal="false" :before-close="cancel" :title="title" append-to-body width="500px" @close="cancel">
      <el-form ref="form" :model="form" :rules="rules" size="small" label-width="88px">
        ...
        <el-form-item label="新密码" prop="newPass">
          <el-input v-model="form.newPass" placeholder="请输入新密码(长度在 8 到 30 个，包含数字和大小写字母)" type="password" auto-complete="on" style="width: 370px;" />
        </el-form-item>
        <el-form-item label="确认密码" prop="confirmPass">
          <el-input v-model="form.confirmPass" placeholder="同新密码保持一致" type="password" auto-complete="on" style="width: 370px;" />
        </el-form-item>
      </el-form>
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        newPass: [
          { required: true, message: '请输入新密码(长度在 8 到 30 个，包含数字和大小写字母)', trigger: 'blur' },
          { min: 8, max: 30, message: '长度在 8 到 30 个，包含数字和大小写字母', trigger: 'blur' }
        ],
        confirmPass: [
