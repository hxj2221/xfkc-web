...
import { getGroupCourseFeatureColumn, getGroupCourse, getCourseFeatureQuery } from '@/api/featureCourse/index'
export default {
  components: {
  },
  props: {
  ...
  methods: {
    ...
    getCourseSource() {
      ...
      getGroupCourseFeatureColumn(params).then(res => {
